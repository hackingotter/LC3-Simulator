    ...
    .FILL 612	; xFD
    .FILL 612	; xFE
    .FILL 612	; xFF; the interrupt vector table
...
OS_START 
    LD  R0, MPR_INIT 	;
    STI R0, OS_MPR 	;;; set timer interval
	
	
    LD  R0, TIM_INIT 	;
    STI R0, OS_TMI 	;;; start running user code (clear Privilege bit w/ JMPT)
...
TRAP_PUTS_DONE 
    ...
    LD  R1, OS_SAVE_R1 	
    LD  R7, OS_SAVE_R7 	
    RET 	;;; IN - prompt the user for a single character input, which is stored
